...
import com.infy.eonservice.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.infy.eonservice.domain.Customer}.
 */
@RestController
@RequestMapping("/api")
@CrossOrigin(origins = "*", allowedHeaders = "*") public class CustomerResource {
    ...
    private static final String ENTITY_NAME = "eonserviceCustomer";
